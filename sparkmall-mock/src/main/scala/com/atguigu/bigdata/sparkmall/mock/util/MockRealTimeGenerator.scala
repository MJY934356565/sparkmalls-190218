...
import com.atguigu.bigdata.sparkmall.common.model.CityInfo
import com.atguigu.bigdata.sparkmall.common.util.ConfigurationUtil
...
object MockRealTimeGenerator {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val config = ConfigurationUtil.apply("config.properties").config
